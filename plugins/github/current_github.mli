...
module Api : sig
  ...
  module Commit : sig
    ...
    val pr_fork_owner_name : t -> string option
    (** [pr_fork_owner_name t] is the name as "owner/name" of the fork from which the PR originated from, and None if it is a branch *)
  end
